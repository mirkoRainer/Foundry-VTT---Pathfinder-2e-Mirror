...
Hooks.once('setup', () => {
  ...
  const toLocalize = [
    'abilities', 'skills', 'martialSkills', 'currencies', 'saves', 'armorTraits', 'preciousMaterialGrades', 'activationComponents', 'activationCosts', 'activationFrequencies', 'durations',
